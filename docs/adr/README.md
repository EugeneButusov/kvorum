...
| [ADR-027](0027-backfill-confirmation-cutoff.md)              | Backfill confirmation cutoff rule                                                                     | Superseded in part by ADR-046 | 3.10                                    |
...
| [ADR-030](0030-title-extraction.md)                          | Per-source title extraction rules                                                                     | Accepted                      | 2.4.4                                   |
...
| [ADR-033](0033-actor-merge-redirects.md)                     | Actor merge produces HTTP 301 redirects on canonical URLs                                             | Proposed                      | 2.4.3, 4.2, 6.20.1, 2.8                 |
...
| [ADR-042](0042-adopt-opentelemetry.md)                       | Adopt OpenTelemetry as the observability SDK; Prometheus as the M1 wire format                        | Superseded in part by ADR-045 | 3.12, 6.20                              |
...
| [ADR-087](0087-service-side-actor-identity-resolution.md)    | Resolve actor identity in the service, not inside ClickHouse                                          | Proposed                      | 6.7, 6.9, 6.12                          |
