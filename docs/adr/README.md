...
| [ADR-036](0036-user-create-update-commands.md)    | Extend kvorum-admin user surface with create and update subcommands               | Accepted              | 6.20.1                             |
| [ADR-037](0037-defer-websocket-ingestion.md)      | Defer WebSocket ingestion to v1.x; v1 uses polling only                           | Accepted              | 3.3                                |
| [ADR-038](0038-clickhouse-archive-layer-in-m1.md) | Split ClickHouse archive layer from analytical mirror; archive ships in M1        | Proposed              | 2.6, 2.7, 3.2, 3.3, 3.4, 7.1, 10.4 |
| [ADR-039](0039-compound-choice-ordering.md)       | Compound proposal choice ordinal mapping aligns with on-chain `castVote` enum     | Proposed              | 2.4.6                              |
| [ADR-040](0040-replace-prisma-with-kysely.md)     | Replace Prisma with Kysely; ClickHouse migrations via `clickhouse-migrations` npm | Proposed              | 7.6, 10.2                          |
