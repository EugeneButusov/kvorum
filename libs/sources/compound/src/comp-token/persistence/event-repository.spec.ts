...
import { CompTokenEventRepository } from './event-repository';
import type { CompTokenEventData } from './event-repository.types';

const EVENT_DATA: CompTokenEventData = {
...
describe('CompTokenEventRepository', () => {
