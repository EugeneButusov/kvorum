...
(
    ...
    primary_choice Nullable(Int8),
    choices String DEFAULT '[]' CODEC(ZSTD(1)),
...
(
    ...
    primary_choice_state AggregateFunction(argMax, Nullable(Int8), DateTime64(6)),
    choices_state AggregateFunction(argMax, String, DateTime64(6)),
...
SELECT
    ...
    argMaxMerge(choices_state)                  AS choices,
