...
import type { SplitDelegationArchiveWriterDeps } from './archive-writer.types';
import type { SplitDelegationEvent } from '../domain/types';

export class SplitDelegationArchiveWriter extends BaseArchiveWriter<SplitDelegationEvent> {
  private readonly eventRepo: SplitDelegationArchiveWriterDeps['eventRepo'];

  constructor(deps: SplitDelegationArchiveWriterDeps) {
