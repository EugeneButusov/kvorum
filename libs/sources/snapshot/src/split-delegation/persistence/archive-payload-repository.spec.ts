...
import { SplitDelegationArchivePayloadRepository } from './archive-payload-repository';
...
describe('SplitDelegationArchivePayloadRepository', () => {
  it('skips the lookup for an empty batch', async () => {
    const ch = makeSelectChain([]);
    const repo = new SplitDelegationArchivePayloadRepository({
