...
export class AaveTokenArchivePayloadRepository {
  ...
  async fetchPayloads(
    ...
    return this.chDb
      .selectFrom('archive_event_aave_token')
      .select([
        'chain_id',
        'tx_hash',
        'log_index',
