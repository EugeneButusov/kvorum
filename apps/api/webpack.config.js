...
module.exports = {
  ...
  resolve: {
    ...
    alias: {
      ...
      '@nest/snapshot': path.join(root, 'nest/sources/snapshot/src/index.ts'),
      '@nest/forum': path.join(root, 'nest/sources/forum/src/index.ts'),
      ...
      '@sources/snapshot': path.join(root, 'libs/sources/snapshot/src/index.ts'),
      '@sources/forum': path.join(root, 'libs/sources/forum/src/index.ts'),
    },
  },
  module: {
    rules: [
