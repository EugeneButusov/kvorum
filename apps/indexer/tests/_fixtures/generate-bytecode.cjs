 ...
 * Run with: node apps/indexer/tests/_fixtures/generate-bytecode.cjs
...
const out = `// AUTO-GENERATED by apps/indexer/tests/_fixtures/generate-bytecode.cjs
// Do NOT edit by hand — run: node apps/indexer/tests/_fixtures/generate-bytecode.cjs
...
const outPath = join(__dirname, 'compound-emitter.bytecode.ts');
